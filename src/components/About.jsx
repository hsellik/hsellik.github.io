  ...
  return (
    <>
      ...
      <motion.p variants={fadeIn('', '', 0.1, 1)} className="mt-4 text-secondary text-[17px] max-w-3xl leading-[30px]">
        ...
        backend systems in Java, Node and Python. On the frontend side I have experience with Javascript and Typescript
        with frameworks like React, Vue, and Three.js. I'm a quick learner and collaborate closely with clients to
